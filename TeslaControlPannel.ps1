...
# ============================================================
# Tesla Control Panel - PREMIUM EDITION (FIXED)
# ============================================================
...
for ($i = 0; $i -lt $Tools.Count; $i++) {
    $t = $Tools[$i]
    $toolCardsXaml += @"
    <Border Margin="0,0,0 blue,12" CornerRadius="12" Background="#121418" BorderBrush="#2A2E36" BorderThickness="1">
        <Grid Padding="10">
            ...
            <Button Name="ToolBtn$i" Grid.Column="2" Content="&#xE768;" FontFamily="Segoe MDL2 Assets" FontSize="16" Background="Transparent" Foreground="#00FFA3" BorderThickness="0" Cursor="Hand"/>
        </Grid>
    </Border>
"@
}
...
<Window xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
    ...
    <Border BorderBrush="#1F2229" BorderThickness="1" CornerRadius="20">
        <Grid>
            ...
            <Border Name="HeaderBar" Grid.Row="0" Background="#0D0D0F" CornerRadius="20,20,0,0">
                <Grid Margin="20,0">
...
# -----------------------------
# STARTUP & EVENTS (HET FIX GEDEELTE)
# -----------------------------
try {
    ...
    # Window Dragging inschakelen via de HeaderBar
