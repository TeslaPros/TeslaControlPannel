...
# ============================================================
# Tesla Control Panel - PREMIUM EDITION (STABLE V2 / FIXED)
# ============================================================
...
function Invoke-ToolAction {
    ...
    if ($Tool.Kind -eq 'Folder') {
        try {
            ...
            Write-Log "Kon folder niet openen: $($Tool.Path)"
        }
        return
    }
    ...
    <Border Margin="0,0,0,10" CornerRadius="10" Background="#121418" BorderBrush="#2A2E36" BorderThickness="1">
        <Grid Padding="10">
            ...
            <StackPanel Grid.Column="1" VerticalAlignment="Center" Margin="10,0">
                ...
                <TextBlock Text="$($t.Desc)" Foreground="#666666" FontSize="10" TextWrapping="Wrap"/>
            </StackPanel>
...
# Fix voor niet-ondersteunde properties in WPF-XAML
$xamlText = $xamlText `
...
try {
    ...
    $Window.FindName('Header').Add_MouseLeftButtonDown({
    ...
    $Window.FindName('MinBtn').Add_Click({
