...
function New-ToolCardXaml {
    ...
    $adminBadge = ''
    if ($Tool.Admin) {
        $adminBadge = '<Border Grid.Column="2" Margin="8,0,0,0" Padding="8,2,8,2" Background="#1A2433" BorderBrush="#2E4660" BorderThickness="1" CornerRadius="8"><TextBlock Text="ADMIN" Foreground="#78C7FF" FontSize="9" FontWeight="SemiBold"/></Border>'
    }
...
function Render-ToolCards {
    ...
    for ($i = 0; $i -lt $ToolList.Count; $i++) {
        ...
        $reader = New-Object System.Xml.XmlNodeReader ([xml]$cardXaml)
            ...
            <Border Grid.Row="0"
                ...
                <Grid Margin="22,0,22,0">
                    ...
                    <StackPanel Grid.Column="1" Orientation="Horizontal" VerticalAlignment="Center">
                        <Button Name="MinBtn" Content="&#xE921;" Style="{StaticResource ChromeButtonStyle}"/>
                        <Button Name="CloseBtn" Content="&#xE8BB;" Style="{StaticResource ChromeButtonStyle}"/>
                    </StackPanel>
                </Grid>
            </Border>
                ...
                <Border Grid.Column="0"
                    ...
                    <Grid Margin="22">
                        ...
                        <Border Grid.Row="4"
                                ...
                                BorderBrush="#162333"
                                BorderThickness="1">
                            <ScrollViewer Name="ToolScrollViewer"
                                          Margin="14"
                ...
                <Grid Grid.Column="2">
                    ...
                    <Border Grid.Row="2"
                        ...
                        <Grid Margin="18">
                            ...
                            <Button Name="OpenAppDataBtn" Grid.Column="0" Style="{StaticResource QuickActionStyle}">
                            ...
                            <Button Name="OpenPrefetchBtn" Grid.Column="2" Style="{StaticResource QuickActionStyle}">
                                <StackPanel Orientation="Horizontal">
                                    <TextBlock Text="&#xE8B7;" FontFamily="Segoe MDL2 Assets" Foreground="#7ECFFF" FontSize="14" VerticalAlignment="Center"/>
                            ...
                            <Button Name="ClearLogBtn" Grid.Column="4" Style="{StaticResource QuickActionStyle}">
                                <StackPanel Orientation="Horizontal">
                                    <TextBlock Text="&#xE894;" FontFamily="Segoe MDL2 Assets" Foreground="#7ECFFF" FontSize="14" VerticalAlignment="Center"/>
...
try {
    ...
    Write-Log 'Ultra Premium WPF interface loaded.'
