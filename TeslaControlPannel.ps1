...
# ============================================================
# Tesla Control Panel - PREMIUM EDITION (STABLE V4 / WPF FIX)
# ============================================================
...
function Set-Status {
    ...
    if ($script:StatusValue) {
        ...
        $script:StatusValue.Foreground = $brush
    }
...
# Tool cards opbouwen in geldige WPF-XAML
$toolCards = ""
...
<Window xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
    ...
    <Border BorderBrush="#1F2229" BorderThickness="1" CornerRadius="15" Background="#0A0A0B">
        <Grid>
            <Grid.RowDefinitions>
