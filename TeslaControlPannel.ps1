...
$Tools = @(
    ...
    @{ Name = 'Mod Analyzer';          Icon = [char]0xE943; Kind = 'Command'; Admin = $true;  Cmd = 'powershell -ExecutionPolicy Bypass -Command "Invoke-Expression (Invoke-RestMethod ''https://raw.githubusercontent.com/xkzuto96/xkzutos-mod-analyzer/main/XkzutosModAnalyzer.ps1'')"'; Desc = 'Analyzes Minecraft mods using metadata, hashes, and indicators.'; ButtonType = 'Neutral' },
    ...
    @{ Name = 'Prestige Finder';       Icon = [char]0xE7C1; Kind = 'Command'; Admin = $true;  Cmd = 'powershell -ExecutionPolicy Bypass -Command "Invoke-Expression (Invoke-RestMethod ''https://raw.githubusercontent.com/Sellgui/Egitserpragger/refs/heads/main/Egitserp%20Raper.ps1'')"'; Desc = 'Scans the system for Prestige-related traces and suspicious activity.'; ButtonType = 'Neutral' },
    @{ Name = 'GhostClientFinder';     Icon = [char]0xE774; Kind = 'Command'; Admin = $true;  Cmd = 'powershell -ExecutionPolicy Bypass -Command "Invoke-Expression (Invoke-RestMethod ''https://raw.githubusercontent.com/TeslaPros/GhostClientFucker/refs/heads/main/GhostClientFucker.ps1'')"'; Desc = 'Detects GhostClient traces and related modifications.'; ButtonType = 'Neutral' },
    @{ Name = 'Injector Detector';     Icon = [char]0xE7B3; Kind = 'Command'; Admin = $true;  Cmd = 'powershell -ExecutionPolicy Bypass -NoProfile -Command "iwr ''https://raw.githubusercontent.com/Sellgui/Injectdetect/refs/heads/main/Injector%20Scanner.ps1'' -UseBasicParsing | iex"'; Desc = 'Scans the system for injector traces and suspicious injection activity.'; ButtonType = 'Neutral' },
    @{ Name = 'Prime Macro Detector';  Icon = [char]0xE943; Kind = 'Command'; Admin = $true;  Cmd = 'powershell -ExecutionPolicy Bypass -NoProfile -Command "iwr 'https://raw.githubusercontent.com/Sellgui/Javamacrodetector/refs/heads/main/Macro%20Detector.ps1' -UseBasicParsing | iex"' -UseBasicParsing | iex"'; Desc = 'Detects Prime macro traces and suspicious macro-related activity.'; ButtonType = 'Neutral' },
    @{ Name = 'Anydesk Install';       Icon = [char]0xE8FB; Kind = 'Command'; Admin = $true;  Cmd = 'powershell -ExecutionPolicy Bypass -Command "Invoke-Expression (Invoke-RestMethod ''https://raw.githubusercontent.com/spokwn/powershells/main/anydesk.ps1'')"'; Desc = 'Downloads and installs AnyDesk using the automated installer script.'; ButtonType = 'Neutral' },

    @{ Name = 'Open PowerShell History'; Icon = [char]0xE8A5; Kind = 'PowerShellHistory'; Admin = $false; Desc = 'Opens your PowerShell command history file in Notepad.'; ButtonType = 'Neutral' },
                    ...
                    <Grid Margin="18,0,18,0">
                        ...
                        <StackPanel Orientation="Horizontal" VerticalAlignment="Center">
                            ...
                            <StackPanel Margin="12,0,0,0" VerticalAlignment="Center">
                                <TextBlock Text="TeslaPro CMD Commands" FontSize="18" FontWeight="SemiBold" Foreground="White"/>
                ...
                <Grid>
                    ...
                    <StackPanel Grid.Row="2">
                        <Border CornerRadius="16" Background="#0A1018" BorderBrush="#1C2E40" BorderThickness="1" Padding="16">
                            <TextBlock TextWrapping="Wrap" Foreground="#DCE7F2" FontSize="13">This launcher was made by TeslaPro. If you find a bug or if you have any questions, you can always send a message on Discord: @teamwsf These tools may only be used with TeslaPro's permission.</TextBlock>
                        </Border>
                    </StackPanel>
...
function Invoke-ToolAction {
    ...
    try {
        ...
        if ($Tool.Kind -eq 'PowerShellHistory') {
            $historyPath = Join-Path $env:APPDATA 'Microsoft\Windows\PowerShell\PSReadLine\ConsoleHost_history.txt'

            Set-UiState "Opening history" "Opening PowerShell history file." "Working" "PowerShell History" 35
            Write-Activity "[INFO] Opening PowerShell history: $historyPath"

            if (Test-Path $historyPath) {
                Start-Process 'notepad.exe' -ArgumentList $historyPath
                Set-UiState "Ready" "PowerShell history opened successfully." "Ready" "Completed" 100
                Write-Activity "[OK] PowerShell history opened"
            }
            else {
                Set-UiState "History not found" "PowerShell history file does not exist yet." "Error" "Not Found" 0
                Write-Activity "[ERROR] PowerShell history file not found: $historyPath"
            }
...
Write-Activity "[INFO] PowerShell History button added"
