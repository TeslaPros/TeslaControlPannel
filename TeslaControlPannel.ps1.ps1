                            ...
                            <StackPanel Grid.Row="4">
                                <Border Background="#0B1017" CornerRadius="18" Padding="16" BorderBrush="#1B2837" BorderThickness="1">
                                    <Grid>
                                        ...
                                        <StackPanel><TextBlock Text="Panel Version" Foreground="#7A92A8" FontSize="11"/><TextBlock x:Name="VersionText" Text="Version 1.1" Foreground="#74E8FF" FontSize="16" FontWeight="Bold" Margin="0,4,0,0"/></StackPanel>
            ...
            <Border Width="620" Padding="24" CornerRadius="22" Background="#0D141D" BorderBrush="#203447" BorderThickness="1" HorizontalAlignment="Center" VerticalAlignment="Center">
                ...
                <Grid>
                    ...
                    <Grid><Grid.ColumnDefinitions><ColumnDefinition Width="Auto"/><ColumnDefinition Width="*"/><ColumnDefinition Width="Auto"/></Grid.ColumnDefinitions>
                        ...
                        <StackPanel Grid.Column="1" Margin="14,0,0,0"><TextBlock Text="About This Panel" FontSize="22" FontWeight="SemiBold" Foreground="White"/><TextBlock Text="TeslaProControlCenter" Foreground="#8FA4B8" FontSize="12" Margin="0,4,0,0"/></StackPanel>
                    ...
                    <StackPanel Grid.Row="2"><Border CornerRadius="16" Background="#0A1018" BorderBrush="#1C2E40" BorderThickness="1" Padding="16"><TextBlock TextWrapping="Wrap" Foreground="#DCE7F2" FontSize="13">TeslaProControlCenter 1.0&#10;&#10;This panel launches TeslaPro tools and quick-access folders from a single clean interface.&#10;&#10;Included quick access:&#10;- Open AppData&#10;- Open Prefetch</TextBlock></Border></StackPanel>
